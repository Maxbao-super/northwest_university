...
public class OTablePane extends Pane {
    ...
    public static String typeJudge(String next) {
        ...
        if (split.length == 1) { //单
            ...
            if (split[0].equals(split[1]) && split[1].equals(split[2]) && split[3].equals(split[4]) || split[1].equals(split[2]) && split[2].equals(split[3])  && split[0].equals(split[4]) || split[2].equals(split[3]) && split[3].equals(split[4]) && split[0].equals(split[1]) ) {    //三带二
                return "三带二";
            }
